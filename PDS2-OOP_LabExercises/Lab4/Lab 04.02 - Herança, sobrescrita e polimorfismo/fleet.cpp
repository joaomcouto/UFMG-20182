...
std::vector<Aeroplane*> Fleet::instantiate_fleet(int number_of_planes) {
	...
	Aeroplane *antonov = nullptr;
    
    if (number_of_planes > 6) {
        antonov = new Jet_Plane("Antonov An-225", 1280, 10, 84, 14003.35, 450.80, "Mryia Cargo");
       // Jet_Plane mryia_antonov("Antonov An-225", 1280, 10, 84, 14003.35, 450.80, "Mryia Cargo");
